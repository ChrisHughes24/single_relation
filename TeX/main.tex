...
\cite{The_mathlib_Community_2020}. As of January 2021 this contains 470000 lines of code.

\subsection{Terms and Types}

Lean is based on type theory, every term has a type,
...
Lean expressions, which include Lean proofs.
...
% After typing a second tactic,
\end{exmpl}

There are many other tactics that allow different manipulations of a tactic
state.
