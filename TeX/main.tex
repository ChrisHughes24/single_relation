...
\begin{abstract}
  ...
  a single equality as hypothesis. This is the first implementation of Magnus' Method
  on a computer. We also describe an alternative method for
...
\subsection{The Tactic}\label{tacdescript}
